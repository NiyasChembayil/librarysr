class StudioApp {
    ...
    async handleDocxUpload(e) {
        ...
        statusEl.textContent = '⏱️ Importing Word Document... this may take a moment.';
        statusEl.style.color = '#7d74ff';
        ...
        try {
            ...
            if (data && data.html) {
                ...
                statusEl.textContent = '✅ Import successful! You can now adjust headers if needed.';
